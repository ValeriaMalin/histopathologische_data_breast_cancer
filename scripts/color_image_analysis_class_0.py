...
image_folder = "dataset/subset_images_0"
...
for image_path in tqdm(image_files):
    ...
    features = [image_name] + color_feats + gabor_feats + intensity_feats
...
features_df.to_csv("dataset/graycomatrix_image_analysis_class_0_color.csv", index=False)
